#
#  Be sure to run `pod spec lint BluetoothCommunicate.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BluetoothCommunicate"
  spec.version      = "0.0.1"
  spec.summary      = "蓝牙指令发送库"
  ...
  spec.source       = { :git => "https://github.com/UnfamousCoder-zhangsan/BluetoothCommunicate.git", :tag => "#{spec.version}" }
