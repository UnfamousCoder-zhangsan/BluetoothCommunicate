...
@implementation BabyBluetooth{
    ...
    BBTimeoutToConnectBlock blockTimeoutToConnect;
}
//单例模式
...
- (void)babyStop {
    ...
    babyCentralManager->pocket = [[NSMutableDictionary alloc]init];
    //连接超时
    blockTimeoutToConnect ? blockTimeoutToConnect() : nil;
    //停止扫描，断开连接
...
- (void)setBlockTimeoutConnected:(void (^)(void))block
{
    blockTimeoutToConnect = block;
}
